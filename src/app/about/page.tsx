...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "heyits.vasudevsharma@gmail.com",
    href: "mailto:heyits.vasudevsharma@gmail.com",
  ...
  {
    name: "CodePen",
    href: "https://codepen.io/mustbevasudev",
    content: "/mustbevasudev",
    icon: <FaCodepen height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/vasudevsharma-coder",
    content: "/vasudevsharma-coder",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">VASU SHARMA</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m VASU, a Comp. Sci. Engineer with 1.5 year experience in Devlopment, DevOps and
